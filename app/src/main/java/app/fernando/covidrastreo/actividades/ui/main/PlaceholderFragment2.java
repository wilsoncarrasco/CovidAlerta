...
public class PlaceholderFragment2 extends Fragment{
    ...
    public static Fragment newInstance(int index) {
        ...
        switch (index){
            case 1:
                fragment = new InstruccionAyudaMotorola0();
                break;
            case 2:
                fragment = new InstruccionAyudaMotorola1();
                break;
            case 3:
                fragment = new InstruccionAyudaMotorola2();
                break;
            case 4:
                fragment = new InstruccionAyudaMotorola3();
                break;
            case 5:
                fragment = new InstruccionAyudaMotorola4();
                break;
            case 6:
                fragment = new InstruccionAyudaMotorola5();
                break;
        }
